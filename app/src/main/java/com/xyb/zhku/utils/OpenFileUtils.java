...
public class OpenFileUtils {
    ...
    //打开文件时调用
    public static  void openFiles(Context mCtx,String filesPath) {
        ...
        if (!type.equals("*/*")) {
            try {
                ...
                mCtx.startActivity(showOpenTypeDialog(filesPath));
            }
        } else {
            mCtx. startActivity(showOpenTypeDialog(filesPath));
        }
    ...
    //显示打开方式
    public void show(Context mCtx,String filesPath){
        Intent intent = new Intent();
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setAction(Intent.ACTION_VIEW);
        mCtx.startActivity(showOpenTypeDialog(filesPath));
